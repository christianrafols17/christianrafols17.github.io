...
const Contacts = () => {
  return (
    <div name="Contacts" className='w-full h-screen bg-gradient-to-b from-black to-gray-900 p-4 text-white'>
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            <div className='pb-8'>
                <p className='text-4xl font-bold text-white p-2 inline border-b-4 border-gray-500 '>Contacts</p>
                <p className='py-6'>Submit the form below to get in touch with me.</p>
            </div>
            <div className='flex justify-center items-center'>
                <form action="https://getform.io/f/2e076572-a85a-4fcb-93b9-7fd99f8f3af5" method="POST" className='flex flex-col w-full md:w-1/2 '>
